...
def search(req):
   ...
   #return users_table.select_many('comp_tags(subject_tags, ?)', ['calculus,math'])
   #return users_table.select_many('geo_dist(loc_lat, loc_lon, 50, 50) < 20', [])
...
request_table = {
   ...
   'search':        RequestHandler(search,        set(['session_id', 'query'])),
}
